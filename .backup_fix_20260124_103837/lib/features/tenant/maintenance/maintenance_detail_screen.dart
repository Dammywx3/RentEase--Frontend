...
class MaintenanceDetailScreen extends StatelessWidget {
  ...
  bool get canCancel => status == 'open' || status == 'in_progress' || status == 'on_hold';

  @override
  Widget build(BuildContext context) {
    return AppScaffold(
      topBar: const AppTopBar(title: 'Request Detail', subtitle: 'Timeline & updates'),
      child: Column(
        ...
        children: [
          ...
          Text('Updates', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w900)),
          const SizedBox(height: AppSpacing.sm),
          ...
          PrimaryButton(
            label: 'Add update',
            onPressed: () => ToastService.show(context, 'Add update modal (demo)', success: true),
          ),
