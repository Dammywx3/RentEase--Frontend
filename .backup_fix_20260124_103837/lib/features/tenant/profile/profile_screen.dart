      ...
      child: Column(
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text('Treco Philippe', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w900)),
                    const SizedBox(height: 2),
                    Text('you@example.com', style: Theme.of(context).textTheme.bodyMedium),
                  ],
                ),
              ),
            ],
          ...
          _Tile(
            ...
            title: 'Documents',
            onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const DocumentsListScreen())),
          ),
