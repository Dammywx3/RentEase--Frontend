...
class ApplicationDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
      topBar: const AppTopBar(title: 'Application Detail', subtitle: 'Review timeline & actions'),
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: AppSpacing.sm),
          const _TimelineItem(title: 'Submitted', subtitle: 'Your application was submitted'),
          ...
          if (s == 'approved') ...[
            PrimaryButton(
              label: 'Pay Deposit',
              onPressed: () => ToastService.show(context, 'Push to Payments (wire later)', success: true),
            ),
          ] else if (s == 'pending') ...[
            PrimaryButton(
              label: 'Withdraw',
            ...
            PrimaryButton(
              ...
              onPressed: () => ToastService.show(context, 'Browse similar (demo)', success: true),
            ),
          ] else ...[
            PrimaryButton(
              label: 'Message',
              onPressed: () => ToastService.show(context, 'Message (Phase 2)', success: true),
            ),
          ],
        ],
      ),
