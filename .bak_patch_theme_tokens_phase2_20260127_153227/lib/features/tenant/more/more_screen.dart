...
// ✅ NEW: Payments Hub screen import (adjust path if your folder is different)
...
class MoreScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      ...
      // ✅ Use AppTopBar (no hardcoded top row, no HomeStead/brand name)
      topBar: AppTopBar(
        title: screenTitle,
        centerTitle: true,
      ),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // SECTION 1 (Payment Hub -> Settings)
              _MenuSection(
                children: [
                  // ✅ UPDATED: Payments -> Payment Hub + navigation
                  _MenuRow(
                    ...
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => const PaymentsHubScreen(),
                        ),
                      );
                    },
                  ),
