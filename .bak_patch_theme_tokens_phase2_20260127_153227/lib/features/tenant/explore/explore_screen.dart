...
class _ExploreScreenState extends State<ExploreScreen> {
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      ...
      topBar: AppTopBar(title: 'Explore', subtitle: 'Find your next home'),
      child: DecoratedBox(
...
class _ActionPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bg = filled
        ...
        : AppColors.surface(context).withValues(alpha: 0.62);
    final fg = filled ? AppColors.surface(context) : AppColors.navy;
                    ...
                    if (listing.sponsored)
                      Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Color(0xFF2E5E9A).withValues(alpha: 0.85),
                            borderRadius: BorderRadius.circular(AppRadii.sm),
                          ),
                          child: Text(
                            'Sponsored',
                    ...
                    if (listing.verified)
                      Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Color(0xFF3C7C5A).withValues(alpha: 0.85),
                            borderRadius: BorderRadius.circular(AppRadii.sm),
                          ),
                          child: Text(
                            'Verified',
