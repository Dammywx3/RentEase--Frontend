    ...
    return Row(
      children: [
        ...
        Container(
          ...
          child: Icon(Icons.eco_rounded, color: AppColors.brandGreenDeep),
        ),
        const SizedBox(width: 10),
        Text(
          'HomeStead',
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(Icons.search_rounded, color: Color(0xFF4E5A6D)),
            SizedBox(width: 10),
            Expanded(
              child: Text(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              text,
              style: TextStyle(
                color: filled ? AppColors.surface(context) : AppColors.navy,
                fontWeight: FontWeight.w900,
              ),
            ),
          ],
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Text(
                  'Buy',
                  style: TextStyle(
                    color: buy ? Colors.white : AppColors.textMutedLight,
                    fontWeight: FontWeight.w900,
                    fontSize: 16,
                  ),
                ),
