...
class AppColors {
  ...
  // === Explore demo tokens (to avoid hardcoded hex in screens) ===
  static const brandGreenDeep = Color(
    0xFF3C7C5A,
  ); // used across Explore + nav vibe
  static const dotInactive = Color(0xFFB8C0CF);

  // Placeholder gradients used by demo listing cards (replace with media later)
