...
class _UploadDocumentScreenState extends State<UploadDocumentScreen> {
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      topBar: const AppTopBar(title: 'Upload Document', subtitle: 'KYC / verification'),
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            items: const [
              ...
              DropdownMenuItem(value: 'Utility Bill', child: Text('Utility Bill')),
            ],
            onChanged: (v) => setState(() => _type = v ?? 'ID Card'),
          ),
          const SizedBox(height: AppSpacing.lg),
          OutlinedButton.icon(
            onPressed: () => ToastService.show(context, 'Pick file (demo)', success: true),
