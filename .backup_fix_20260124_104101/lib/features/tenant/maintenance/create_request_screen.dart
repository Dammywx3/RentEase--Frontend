...
class _CreateRequestScreenState extends State<CreateRequestScreen> {
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      topBar: const AppTopBar(title: 'Create Request', subtitle: 'Describe the issue'),
      child: Form(
        key: _formKey,
        child: Column(
          children: [
            Align(alignment: Alignment.centerLeft, child: Text('Category', style: Theme.of(context).textTheme.labelLarge)),
            ...
            Align(alignment: Alignment.centerLeft, child: Text('Priority', style: Theme.of(context).textTheme.labelLarge)),
            const SizedBox(height: AppSpacing.xs),
            DropdownButtonFormField<String>(
              value: _priority,
              items: const [
