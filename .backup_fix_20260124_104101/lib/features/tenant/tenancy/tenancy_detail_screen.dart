...
class TenancyDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      topBar: const AppTopBar(title: 'Tenancy Detail', subtitle: 'Timeline & actions'),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Lease Documents', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w900)),
          ...
          Text('End Tenancy', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w900)),
          const SizedBox(height: AppSpacing.sm),
          PrimaryButton(
            label: 'Request end tenancy',
            onPressed: () => ToastService.show(context, 'End tenancy form (demo)', success: true),
          ),
