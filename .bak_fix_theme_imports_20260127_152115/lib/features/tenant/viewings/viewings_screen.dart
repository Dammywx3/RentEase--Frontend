  ...
  Widget build(BuildContext context) {
    Widget tab(_Tab t, String label) {
      ...
      return Expanded(
        child: Material(
          color: selected
              ? const Color(0xFF2E5E9A).withValues(alpha: 0.24)
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.surface(context).withValues(alpha: 0.45)),
      ),
      child: Row(
        children: [
...
class _MiniAction extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final tc = textColor ?? const Color(0xFF1E2A3A);
    final ic = iconColor ?? const Color(0xFF6F7785);
