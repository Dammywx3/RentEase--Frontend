  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
      topBar: const AppTopBar(
        title: 'Viewings',
        subtitle: 'Approve / reschedule / complete',
      ),
      child: Column(
        children: [
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: Theme.of(context)
                                  .colorScheme
                                  .outlineVariant
                                  .withValues(alpha: ((255 * (0.35)).round())),
                            ),
                            color: Theme.of(context)
                                .colorScheme
                                .surfaceContainerHighest
                                .withValues(alpha: ((255 * (0.15)).round())),
                          ),
                          child: Row(
