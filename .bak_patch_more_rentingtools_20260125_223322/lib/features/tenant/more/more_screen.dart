...
class MoreScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // ✅ Scaffold gives Material ancestor (fixes: "No Material widget found")
    return Scaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                _MenuTile(
                  ...
                  title: 'Payments',
                  onTap: () => _toast(context, 'Payments (wire later)'),
                ),
                const SizedBox(height: 10),

                // ✅ Renting Tools should open RentingToolsScreen
                _MenuTile(
                ...
                _MenuTile(
                  ...
                  iconFg: _green,
                  title: 'Maintenance',
                  onTap: () => _toast(context, 'Maintenance (wire later)'),
                ),
                const SizedBox(height: 10),
                ...
                _MenuTile(
                  ...
                  iconFg: const Color(0xFF6B6B6B),
                  title: 'Settings',
                  onTap: () => _toast(context, 'Settings (wire later)'),
                ),
                const SizedBox(height: 14),
                ...
                _GroupCard(
                  children: [
                    _MenuRow(
                      ...
                      onTap: () =>
                          _toast(context, 'Invite Friends (wire later)'),
                    ),
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              ...
              // ✅ FIX: only ONE child (your file had duplicated child line)
