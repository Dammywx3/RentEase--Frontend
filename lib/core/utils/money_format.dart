...
String fmtNairaCompact(num v) {
  final n = v.toDouble();
  if (n >= 1000000000) { return '₦${(n / 1000000000).toStringAsFixed(1)}B'; }  if (n >= 1000000) { return '₦${(n / 1000000).toStringAsFixed(1)}M'; }  if (n >= 1000) { return '₦${(n / 1000).toStringAsFixed(1)}K'; }  return fmtNaira(n);
}
