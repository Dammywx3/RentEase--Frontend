...
class VerifyEmailScreen extends StatefulWidget {
  const VerifyEmailScreen({
    ...
    // ✅ remove HomeStead hardcode (same pattern as RegisterScreen)
    ...
    Navigator.of(context).pushAndRemoveUntil(
      MaterialPageRoute(
        builder: (_) => PostLoginWelcomeScreen(
          fullName: widget.fullName.trim().isEmpty ? 'Michael' : widget.fullName.trim(),
          role: widget.role,
        ),
      ),
      (r) => false,
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                // ✅ Clean top row: back + perfectly centered brand (no odd spacing)
                SizedBox(
                  height: 48,
                  child: Stack(
