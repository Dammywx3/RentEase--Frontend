          ...
          children: [
            Row(
              children: [
                ...
                StatusBadge(domain: StatusDomain.viewing, status: status, compact: true),
              ],
            ),
            const SizedBox(height: AppSpacing.md),
            _MetaLine(icon: Icons.schedule_rounded, text: dateTimeText),
            const SizedBox(height: AppSpacing.xs),
            _MetaLine(icon: Icons.videocam_rounded, text: modeText),
