  ...
  Widget build(BuildContext context) {
    ...
    switch (spec.tone) {
      case BadgeTone.success:
        bg = (isDark ? AppColors.brandGreen : AppColors.brandGreen).withAlpha(isDark ? 40 : 28);
        fg = AppColors.brandGreen;
        break;
      case BadgeTone.warning:
        bg = (isDark ? AppColors.brandOrange : AppColors.brandOrange).withAlpha(isDark ? 45 : 28);
        fg = AppColors.brandOrange;
        break;
      case BadgeTone.danger:
        bg = (isDark ? AppColors.danger : AppColors.danger).withAlpha(isDark ? 45 : 26);
        fg = AppColors.danger;
        break;
      case BadgeTone.info:
        bg = (isDark ? AppColors.brandBlueSoft : AppColors.brandBlue).withAlpha(isDark ? 40 : 22);
        fg = isDark ? AppColors.brandBlueSoft : AppColors.brandBlue;
        break;
      case BadgeTone.neutral:
        bg = (isDark ? AppColors.textMutedLight : AppColors.textMutedDark).withAlpha(isDark ? 28 : 18);
