              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: const [
                    ...
                    DropdownMenuItem(initialValue: 'AC', child: Text('AC')),
                    DropdownMenuItem(
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: const [
                    DropdownMenuItem(initialValue: 'Low', child: Text('Low')),
                    DropdownMenuItem(
                      initialValue: 'Normal',
                      child: Text('Normal'),
                    ),
                    ...
                    DropdownMenuItem(initialValue: 'High', child: Text('High')),
                  ],
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Switch(
                      initialValue: _permissionToEnter,
