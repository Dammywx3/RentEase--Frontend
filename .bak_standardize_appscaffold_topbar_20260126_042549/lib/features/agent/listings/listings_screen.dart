...
class _ListingsScreenState extends State<ListingsScreen> {
  ...
  final _items = const [
    ...
    _ListingRow(
      ...
      status: 'draft',
      price: 'NGN 450,000',
      meta: 'Studio • 1 bed • 1 bath',
    ),
    _ListingRow(
      id: 'al4',
      title: 'Old Listing (Needs renew)',
      location: 'Surulere, Lagos',
      status: 'expired',
      price: 'NGN 900,000',
      meta: 'Flat • 2 bed • 1 bath',
    ),
    _ListingRow(
      id: 'al5',
  ...
  List<_ListingRow> get _filtered {
    switch (_tab) {
      ...
      case 'Pending':
        return _items
            .where((x) => x.status == 'pending_owner_approval')
            .toList();
      case 'Rejected':
        ...
        actions: [
          IconButton(
            onPressed: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (_) => const CreateListingStepper()),
            ),
                ...
                : ListView.separated(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return ListingCard(
                        ...
                        primaryActionText: x.status == 'draft'
                            ? 'Edit'
                            : 'Manage',
