  ...
  static ThemeData light() {
    ...
    return base.copyWith(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: text.bodyMedium?.copyWith(color: AppColors.textDark2.withValues(alpha: 0.85)),
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(AppRadii.input),
          borderSide: BorderSide(color: AppColors.brandBlue.withValues(alpha: 0.75), width: 1.4),
        ),
      ...
      chipTheme: ChipThemeData(
        ...
        secondaryLabelStyle: text.labelMedium?.copyWith(color: AppColors.textDark),
  ...
  static ThemeData dark() {
    ...
    return base.copyWith(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(AppRadii.input),
          borderSide: BorderSide(color: AppColors.brandGreen.withValues(alpha: 0.85), width: 1.4),
        ),
        contentPadding: const EdgeInsets.symmetric(horizontal: 14, vertical: 14),
      ),
      ...
      chipTheme: ChipThemeData(
        ...
        secondaryLabelStyle: text.labelMedium?.copyWith(color: AppColors.textLight),
        padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 8),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(AppRadii.chip),
          side: const BorderSide(color: AppColors.darkBorder),
