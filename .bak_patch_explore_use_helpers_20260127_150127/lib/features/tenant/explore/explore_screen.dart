    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(AppRadii.button),
          border: Border.all(color: AppColors.lightOverlay(0.06)),
          boxShadow: [
            BoxShadow(
              blurRadius: 18,
              offset: const Offset(0, 10),
              color: AppColors.lightOverlay(0.08),
            ),
          ],
        ),
        child: Row(
          children: [
            const Icon(Icons.search_rounded, color: AppColors.textDark2),
            const SizedBox(width: 10),
            Expanded(
              child: Text(
...
class _ActionPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final fg = filled ? AppColors.lightSurface : AppColors.navy;
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        padding: const EdgeInsets.symmetric(horizontal: 12),
        decoration: BoxDecoration(
          color: AppColors.lightSurface.withValues(alpha: 0.55),
          borderRadius: BorderRadius.circular(AppRadii.chip),
          border: Border.all(color: AppColors.lightOverlay(0.06)),
        ),
        child: Row(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              ...
              color: AppColors.lightOverlay(0.10),
            ),
          ],
        ),
        child: ClipRRect(
                      ...
                      child: Text(
                        ...
                        style: Theme.of(context).textTheme.titleLarge?.copyWith(
                          ...
                          shadows: [
                            Shadow(
                              blurRadius: 18,
                              color: AppColors.lightOverlay(0.35),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(AppRadii.button),
          border: Border.all(color: AppColors.lightOverlay(0.05)),
          boxShadow: [
            BoxShadow(
              blurRadius: 16,
              offset: const Offset(0, 10),
              ...
              AspectRatio(
                ...
                child: Stack(
                  ...
                  children: [
                    Container(
                      decoration: const BoxDecoration(
                        gradient: AppColors.demoCardGradientB,
                      ),
                      child: Center(
                        child: Icon(
                          listing.beds == 0
      ...
      children: [
        for (int i = start; i < end; i++)
          Container(
            ...
            width: i == index ? 20 : 8,
            decoration: BoxDecoration(
              color: i == index ? active : AppColors.dotInactive,
